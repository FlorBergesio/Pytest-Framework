...
def test_selenium_automated_input_value():
...
def test_riddle_of_stone():
    browser = webdriver.Chrome()
    browser.get("https://techstepacademy.com/trial-of-the-stones")
    inputStonePath = "input[id='r1Input']"
    inputStoneElement = browser.find_element(By.CSS_SELECTOR, inputStonePath)
    inputStoneElement.send_keys("rock")
    time.sleep(1)
    buttonStonePath = "button[id='r1Btn']"
    buttonStoneElement = browser.find_element(By.CSS_SELECTOR, buttonStonePath)
    buttonStoneElement.click()
    time.sleep(1)
    passwordContainerStonePath = "div[id='passwordBanner']"
    passwordContainerStoneElement = browser.find_element(By.CSS_SELECTOR, passwordContainerStonePath)
    """ passwordStonePath = "//div[@id='passwordBanner']/h4"
    passwordStoneElement = browser.find_element(By.XPATH, passwordStonePath) """
    time.sleep(1)
